...
public class SamlMetaDataValidator implements MetadataValidator {
  ...
  /**
   * Constructs an instance of SamlMetaDataValidator with the default, most restrictive {@link SsrfGuard}.
   */
  ...
  /**
   * Constructs an instance of SamlMetaDataValidator using the given {@link SsrfGuard} configuration for outbound
   * calls (e.g. pinging {@code metadata_endpoint}).
   *
   * @param ssrfGuard the guard used to block outbound calls to internal/private networks
   */
  public SamlMetaDataValidator(final SsrfGuard ssrfGuard) {
